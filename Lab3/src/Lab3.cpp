...
namespace Demo
{
    class Lab3GraphicsSystem : public GraphicsSystem
    {
    ...
    public:
        Lab3GraphicsSystem( GameState *gameState ) :
    ...
    {
        Lab3GameState *gfxGameState = new Lab3GameState(
        "Empty Project Example" );

        GraphicsSystem *graphicsSystem = new Lab3GraphicsSystem( gfxGameState );
