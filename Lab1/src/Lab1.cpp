...
namespace Demo
{
    class Lab1GraphicsSystem : public GraphicsSystem
    {
    ...
    public:
        Lab1GraphicsSystem( GameState *gameState ) :
    ...
    {
        Lab1GameState *gfxGameState = new Lab1GameState(
        "Empty Project Example" );

        GraphicsSystem *graphicsSystem = new Lab1GraphicsSystem( gfxGameState );
